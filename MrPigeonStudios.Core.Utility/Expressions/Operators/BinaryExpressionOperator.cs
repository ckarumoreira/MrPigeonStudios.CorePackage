...
namespace MrPigeonStudios.Core.Utility.Expressions.Operators {
    ...
    public sealed class BinaryExpressionOperator : IExpressionOperator {
        ...
        public static BinaryExpressionOperator And = new() { Operation = Expression.AndAlso, Keyword = "AND" };
        ...
        public static BinaryExpressionOperator Or = new() { Operation = Expression.OrElse, Keyword = "OR" };
